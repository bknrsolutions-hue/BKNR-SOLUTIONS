...
from .general_stock.general_stock_items import router as general_stock_items_router  
from .general_stock.general_stock_report import router as general_stock_report_router
