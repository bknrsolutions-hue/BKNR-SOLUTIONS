...
from app.routers.attendance.salary_advance import router as salary_advance_router  # ✅ ADD
...
attendance_api.include_router(salary_advance_router)  # /attendance/salary-advance ✅
