...
class ProformaInvoice(Base):
    ...
    packing_style = Column(String, nullable=True)
    freezer = Column(String, nullable=True)
    count_glaze = Column(String, nullable=True)
    weight_glaze = Column(String, nullable=True)
