  ...
  return <KeyboardAvoidingView style={styles.page} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
    ...
    <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.card}>
        ...
        {screen === 'otp' && <View style={styles.form}><TextInput style={styles.otp} value={otp} onChangeText={value => setOtp(value.replace(/\D/g, '').slice(0, 6))} placeholder="••••••" placeholderTextColor="#8391a7" keyboardType="number-pad" textContentType="oneTimeCode" maxLength={6} autoFocus onSubmitEditing={verifyOtp} returnKeyType="done" /><PrimaryButton label="Verify OTP" loading={loading} onPress={verifyOtp} /></View>}
