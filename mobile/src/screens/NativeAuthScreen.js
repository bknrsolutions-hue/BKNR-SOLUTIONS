...
const styles = StyleSheet.create({
  ...
  logoBadge: { width: 72, height: 72, borderRadius: 36, backgroundColor: '#2563eb', alignItems: 'center', justifyContent: 'center', shadowColor: '#2563eb', shadowOpacity: .35, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 6 },
  companyLogo: { width: 44, height: 44, tintColor: '#ffffff' },
