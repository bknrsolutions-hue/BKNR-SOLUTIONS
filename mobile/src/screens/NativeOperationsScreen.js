...
const styles = StyleSheet.create({
  ...
  heroEmoji: { fontSize: 33 },
  heroCopy: { flex: 1, minWidth: 0 },
  heroTitle: { color: '#0f172a', fontSize: 15, fontWeight: '900' },
  heroText: { marginTop: 4, color: '#64748b', fontSize: 12, lineHeight: 14, fontWeight: '650' },
  sectionTitle: { marginTop: 20, marginBottom: 10, color: '#64748b', fontSize: 12, fontWeight: '900', letterSpacing: 1 },
  ...
  emoji: { fontSize: 29 },
  label: { marginTop: 10, color: '#0f172a', fontSize: 11, fontWeight: '900' },
  note: { marginTop: 4, minHeight: 28, color: '#64748b', fontSize: 10.5, lineHeight: 11, fontWeight: '650' },
  status: { alignSelf: 'flex-start', marginTop: 8, paddingHorizontal: 7, paddingVertical: 4, borderRadius: 999 },
  statusText: { fontSize: 12, fontWeight: '900', letterSpacing: .4 },
  selection: { marginTop: 15, padding: 15, borderWidth: 1, borderColor: '#fed7aa', borderRadius: 17, backgroundColor: '#fff7ed' },
  selectionTitle: { color: '#1c1917', fontSize: 13, fontWeight: '900' },
  selectionText: { marginTop: 5, color: '#78716c', fontSize: 11.5, lineHeight: 14, fontWeight: '650' },
  ...
  quickLabel: { color: '#1e3a5f', fontSize: 12, fontWeight: '850' },
});
