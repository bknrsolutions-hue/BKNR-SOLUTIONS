...
const styles = StyleSheet.create({
  ...
  welcome: { marginTop: 3, color: '#ffffff', fontSize: 23, fontWeight: '900', letterSpacing: -.5 },
  companyRow: { marginTop: 4, flexDirection: 'row', alignItems: 'center', gap: 2, minWidth: 0 },
  company: { flexShrink: 1, color: '#b8c7dc', fontSize: 11, fontWeight: '750' },
  ...
  headerActionLabel: { marginTop: 3, fontSize: 6.8, fontWeight: '900' },
  ...
  searchInput: { flex: 1, color: '#0f172a', fontSize: 13, fontWeight: '750' },
  heading: { marginTop: 16, marginBottom: 9, color: '#0f172a', fontSize: 15, fontWeight: '900' },
  titleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  seeAll: { marginTop: 14, marginBottom: 8, color: '#2563eb', fontSize: 11, fontWeight: '900' },
  ...
  filterHint: { marginTop: 11, color: '#64748b', fontSize: 9.5, fontWeight: '700' },
  filterError: { marginTop: 7, color: '#dc2626', fontSize: 10.5, lineHeight: 15, fontWeight: '850' },
  ...
  featureCopy: { flex: 1 },
  featureTitle: { marginTop: 8, color: '#0f172a', fontSize: 12.5, fontWeight: '900' },
  featureNote: { marginTop: 3, color: '#64748b', fontSize: 9.5, fontWeight: '700' },
  ...
  cardTitle: { marginTop: 8, color: '#0f172a', fontSize: 12, fontWeight: '900' },
  cardNote: { marginTop: 4, color: '#64748b', fontSize: 9.5, fontWeight: '700' },
  ...
  logoutTitle: { marginTop: 8, color: '#dc2626', fontSize: 12, fontWeight: '900' },
  ...
  bottomLabel: { color: '#64748b', fontSize: 9, fontWeight: '850' },
});
