...
const appItems = [
  ...
  { key: 'hrms_daily_attendance', tab: 'hrms', icon: 'badge-account-horizontal-outline', label: 'Daily Attendance', note: 'HR terminal', color: '#0f766e', perm: 'daily_attendance' },
  { key: 'hrms_contract_workers', tab: 'hrms', icon: 'account-hard-hat-outline', label: 'Contract Workers', note: 'Registration & punching', color: '#c2410c', perm: 'labour_management' },
  { key: 'hrms_kg_company_staff', tab: 'hrms', icon: 'weight-kilogram', label: 'KG Company Staff', note: 'Registration & punching', color: '#7c3aed', perm: 'kg_basis_labour' },
  { key: 'hrms_visitors_workers', tab: 'hrms', icon: 'account-arrow-right-outline', label: 'Visitors & Day Workers', note: 'Entry & approval', color: '#0891b2', perm: 'visitors_day_workers' },
  { key: 'hrms_approvals', tab: 'hrms', icon: 'account-check-outline', label: 'Approvals', note: 'Visitors & day workers', color: '#15803d' },
...
const tabs = [
  ...
  { key: 'hrms', icon: 'account-group-outline', activeIcon: 'account-group', label: 'HR & Staff' },
