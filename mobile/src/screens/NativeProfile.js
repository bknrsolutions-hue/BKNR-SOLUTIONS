...
const styles = StyleSheet.create({
  ...
  formTitle: { fontSize: 11.5, fontWeight: '900' },
  formHint: { marginTop: 2, fontSize: 8.5, fontWeight: '700' },
  ...
  rowLabel: { fontSize: 8, fontWeight: '900', letterSpacing: .55, textTransform: 'uppercase' },
  rowValue: { marginTop: 3, fontSize: 11.5, lineHeight: 16, fontWeight: '850' },
  ...
  errorText: { flex: 1, color: '#dc2626', fontSize: 10.5, lineHeight: 15, fontWeight: '800' },
});
