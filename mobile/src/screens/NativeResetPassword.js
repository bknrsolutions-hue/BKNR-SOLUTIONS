...
const styles = StyleSheet.create({ page: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 18, backgroundColor: '#f4f7fb' }, card: { width: '100%', maxWidth: 430, padding: 22, borderWidth: 1, borderColor: '#dbe3ef', borderRadius: 22, backgroundColor: '#fff' }, icon: { width: 46, height: 46, alignSelf: 'center', alignItems: 'center', justifyContent: 'center', borderRadius: 15, backgroundColor: '#2563eb' }, iconText: { color: '#fff', fontSize: 22, fontWeight: '900' }, title: { marginTop: 12, color: '#0f172a', fontSize: 23, fontWeight: '900', textAlign: 'center' }, subtitle: { margin: 7, marginBottom: 18, color: '#64748b', fontSize: 11, lineHeight: 17, textAlign: 'center' }, error: { marginBottom: 10, padding: 10, borderRadius: 10, color: '#dc2626', backgroundColor: '#fef2f2', fontSize: 10 }, input: { height: 50, marginBottom: 11, paddingHorizontal: 13, borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 12, color: '#0f172a', backgroundColor: '#fff' }, button: { height: 50, alignItems: 'center', justifyContent: 'center', borderRadius: 12, backgroundColor: '#2563eb' }, buttonText: { color: '#fff', fontSize: 12, fontWeight: '900' } });
