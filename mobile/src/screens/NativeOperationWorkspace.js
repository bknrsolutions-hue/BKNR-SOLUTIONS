...
const auxiliaryMeta = {
  ...
  peeling: [['hlso_floor_balance', 'HLSO Floor Balance', ['production_for', 'location', 'batch', 'count', 'species', 'variety', 'available_qty']], ['hlso_summary', 'HLSO Summary', ['species', 'variety', 'count', 'total_kg']], ['variety_summary', 'Variety Summary', ['variety_name', 'total_hlso']]],
...
const styles = StyleSheet.create({
  ...
  tabText: { color: '#64748b', fontSize: 8.5, fontWeight: '900' },
  tabTextActive: { color: '#fff' },
  form: { gap: 8, padding: 9, borderWidth: 1, borderColor: '#dbe3ef', borderRadius: 13, backgroundColor: '#fff' },
  field: { width: '100%' },
  label: { marginBottom: 4, color: '#64748b', fontSize: 8.5, fontWeight: '900', textTransform: 'uppercase', letterSpacing: .35 },
  required: { color: '#dc2626' },
  input: { height: 42, paddingHorizontal: 10, borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 10, color: '#0f172a', backgroundColor: '#fff', fontSize: 10.5, fontWeight: '750' },
  ...
  searchButtonText: { color: '#fff', fontSize: 11, fontWeight: '900', textTransform: 'uppercase' },
  lineList: { gap: 10 },
  ...
  lineTitle: { color: '#1d4ed8', fontSize: 11, fontWeight: '900' },
  lineSub: { marginTop: 2, color: '#64748b', fontSize: 9, fontWeight: '700' },
  lineBalance: { color: '#0f766e', fontSize: 10, fontWeight: '900', textAlign: 'right' },
  ...
  addLineText: { color: '#1d4ed8', fontSize: 10, fontWeight: '900' },
  removeLine: { paddingHorizontal: 9, paddingVertical: 6, borderRadius: 8, backgroundColor: '#fee2e2' },
  removeLineText: { color: '#dc2626', fontSize: 9, fontWeight: '900' },
  availableCard: { padding: 11, borderWidth: 1, borderRadius: 11 },
  availableLabel: { fontSize: 8.5, fontWeight: '900', letterSpacing: .45 },
  availableValue: { marginTop: 3, fontSize: 14, fontWeight: '900' },
  message: { marginTop: 12, padding: 11, borderWidth: 1, borderColor: '#fecaca', borderRadius: 10, color: '#dc2626', backgroundColor: '#fef2f2', fontSize: 11, fontWeight: '800' },
  ...
  errorBannerText: { flex: 1, color: '#dc2626', fontSize: 11, lineHeight: 15, fontWeight: '800' },
  errorClose: { width: 34, height: 34, alignItems: 'center', justifyContent: 'center', borderRadius: 9, backgroundColor: '#fee2e2' },
  errorCloseText: { color: '#b91c1c', fontSize: 22, lineHeight: 24, fontWeight: '700' },
  ...
  successTitle: { marginTop: 14, color: '#14532d', fontSize: 20, fontWeight: '900' },
  successCopy: { marginTop: 6, color: '#64748b', fontSize: 11, lineHeight: 16, fontWeight: '700', textAlign: 'center' },
  ...
  successButtonText: { color: '#fff', fontSize: 11, fontWeight: '900' },
  ...
  tableCell: { minHeight: 32, paddingHorizontal: 4, paddingVertical: 5, color: '#334155', fontSize: 8.5, lineHeight: 10, fontWeight: '650' },
  ...
  auxLocationHeaderText: { color: '#1e3a5f', fontSize: 8.5, fontWeight: '900', letterSpacing: .35 },
  ...
  auxSubtotalLabel: { color: '#64748b', fontSize: 7.5, fontWeight: '900', textTransform: 'uppercase' },
  auxSubtotalValue: { minWidth: 74, color: '#0f766e', fontSize: 9, fontWeight: '900', textAlign: 'right' },
  ...
  statusPickerText: { color: '#1e3a5f', fontSize: 7.5, fontWeight: '900' },
  ...
  statusTitle: { padding: 16, fontSize: 15, fontWeight: '900' },
  ...
  doneButtonText: { color: '#fff', fontSize: 7.5, fontWeight: '900' },
  rowCancel: { paddingHorizontal: 6, paddingVertical: 4, borderRadius: 6, backgroundColor: '#fee2e2' },
  rowCancelText: { color: '#dc2626', fontSize: 8, fontWeight: '900' },
  cancelledText: { color: '#dc2626', fontSize: 8, fontWeight: '900' },
  noRows: { padding: 20, color: '#64748b', fontSize: 11, textAlign: 'center' },
  cancelPanel: { marginTop: 12, gap: 9, padding: 13, borderWidth: 1, borderColor: '#fecaca', borderRadius: 12, backgroundColor: '#fff' },
  cancelTitle: { color: '#dc2626', fontSize: 14, fontWeight: '900' },
  cancelSub: { color: '#64748b', fontSize: 10, fontWeight: '700' },
  ...
  keepText: { color: '#475569', fontSize: 10, fontWeight: '900' },
