...
const styles = StyleSheet.create({ error: { marginBottom: 10, padding: 10, borderWidth: 1, borderColor: '#fecaca', borderRadius: 10, color: '#dc2626', backgroundColor: '#fef2f2', fontSize: 12, fontWeight: '800' }, newButton: { height: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderRadius: 12, backgroundColor: '#2563eb' }, newButtonText: { color: '#fff', fontSize: 11, fontWeight: '900' }, search: { height: 44, marginTop: 10, paddingHorizontal: 12, borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 11, color: '#0f172a', backgroundColor: '#fff', fontSize: 10 }, ticket: { minHeight: 82, flexDirection: 'row', alignItems: 'center', gap: 12, padding: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#dbe3ef', backgroundColor: '#fff' }, ticketCopy: { flex: 1, minWidth: 0 }, ticketNumber: { color: '#2563eb', fontSize: 11, fontWeight: '900' }, ticketSubject: { marginTop: 4, color: '#0f172a', fontSize: 11, fontWeight: '850' }, ticketDate: { marginTop: 4, color: '#64748b', fontSize: 10, fontWeight: '700' }, status: { paddingHorizontal: 8, paddingVertical: 5, borderRadius: 999, color: '#a16207', backgroundColor: '#fef9c3', fontSize: 10, fontWeight: '900' }, resolved: { color: '#15803d', backgroundColor: '#dcfce7' }, modalOverlay: { flex: 1, justifyContent: 'flex-end', backgroundColor: '#02061788' }, modalCard: { padding: 18, paddingBottom: 28, borderTopLeftRadius: 24, borderTopRightRadius: 24, backgroundColor: '#fff' }, modalHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 15 }, modalTitle: { color: '#0f172a', fontSize: 16, fontWeight: '900' }, close: { color: '#64748b', fontSize: 26 }, input: { minHeight: 50, marginBottom: 11, paddingHorizontal: 13, borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 12, color: '#0f172a', backgroundColor: '#fff', fontSize: 11, fontWeight: '700' }, messageInput: { height: 115, paddingTop: 13 }, submit: { height: 50, alignItems: 'center', justifyContent: 'center', borderRadius: 12, backgroundColor: '#2563eb' }, submitText: { color: '#fff', fontSize: 11, fontWeight: '900' }, chatPage: { flex: 1, backgroundColor: '#f4f7fb' }, chatHeader: { minHeight: 66, flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 14, borderBottomWidth: 1, borderBottomColor: '#dbe3ef', backgroundColor: '#fff' }, chatBack: { width: 36, height: 36, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 10, backgroundColor: '#eff6ff' }, chatBackText: { color: '#2563eb', fontSize: 26 }, chatCopy: { flex: 1 }, chatTitle: { color: '#0f172a', fontSize: 12, fontWeight: '900' }, chatSub: { marginTop: 3, color: '#64748b', fontSize: 11, fontWeight: '700' }, messages: { flexGrow: 1, padding: 14, gap: 9 }, bubble: { maxWidth: '84%', padding: 11, borderRadius: 14 }, userBubble: { alignSelf: 'flex-end', backgroundColor: '#2563eb' }, supportBubble: { alignSelf: 'flex-start', borderWidth: 1, borderColor: '#dbe3ef', backgroundColor: '#fff' }, sender: { marginBottom: 4, color: '#2563eb', fontSize: 10, fontWeight: '900' }, message: { color: '#0f172a', fontSize: 10, lineHeight: 16, fontWeight: '650' }, userMessage: { color: '#fff' }, media: { marginTop: 6, color: '#2563eb', fontSize: 11, fontWeight: '900', textDecorationLine: 'underline' }, time: { marginTop: 5, color: '#94a3b8', fontSize: 12, textAlign: 'right' }, fileBar: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10, paddingHorizontal: 13, paddingVertical: 8, backgroundColor: '#dbeafe' }, fileName: { flex: 1, color: '#1e3a5f', fontSize: 11, fontWeight: '750' }, fileRemove: { color: '#dc2626', fontSize: 20 }, replyBar: { flexDirection: 'row', alignItems: 'flex-end', gap: 8, padding: 10, borderTopWidth: 1, borderTopColor: '#dbe3ef', backgroundColor: '#fff' }, attach: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 11 }, attachText: { color: '#2563eb', fontSize: 20 }, replyInput: { flex: 1, maxHeight: 90, minHeight: 44, paddingHorizontal: 12, paddingVertical: 10, borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 12, color: '#0f172a', backgroundColor: '#fff', fontSize: 10 }, send: { height: 44, justifyContent: 'center', paddingHorizontal: 16, borderRadius: 11, backgroundColor: '#2563eb' }, sendText: { color: '#fff', fontSize: 12, fontWeight: '900' } });
