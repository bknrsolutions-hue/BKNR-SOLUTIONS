...
const styles = StyleSheet.create({
  ...
  totalLabel: { fontSize: 11, fontWeight: '900', letterSpacing: .6 },
  totalValue: { marginTop: 5, fontSize: 25, fontWeight: '900' },
  totalMeta: { marginTop: 3, fontSize: 10.5, fontWeight: '700' },
  ...
  cell: { minHeight: 32, paddingHorizontal: 4, paddingVertical: 5, color: '#334155', fontSize: 9.5, lineHeight: 11, fontWeight: '650' },
  ...
  locationHeaderText: { color: '#1e3a5f', fontSize: 10, fontWeight: '900', letterSpacing: .4 },
  companyHeader: { paddingLeft: 14, backgroundColor: '#eef2ff' },
  companyHeaderText: { color: '#4338ca', fontSize: 9, fontWeight: '900', letterSpacing: .3 },
  ...
  subtotalLabel: { color: '#64748b', fontSize: 8.5, fontWeight: '900', textTransform: 'uppercase' },
  subtotalValue: { minWidth: 76, color: '#0f766e', fontSize: 10, fontWeight: '900', textAlign: 'right' },
  ...
  grandLabel: { color: '#1e3a5f', fontSize: 10, fontWeight: '900' },
  grandValue: { minWidth: 86, color: '#1d4ed8', fontSize: 11, fontWeight: '900', textAlign: 'right' },
  empty: { width: tableWidth, padding: 22, fontSize: 12, fontWeight: '700', textAlign: 'center' },
});
