...
const styles = StyleSheet.create({
  dateRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10, padding: 9, borderWidth: 1, borderColor: '#dbe3ef', borderRadius: 11, backgroundColor: '#fff' }, dateLabel: { color: '#64748b', fontSize: 9, fontWeight: '900', textTransform: 'uppercase' }, dateButton: { minWidth: 150, height: 36, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8, paddingHorizontal: 10, borderWidth: 1, borderColor: '#bfdbfe', borderRadius: 9, backgroundColor: '#eff6ff' }, dateButtonText: { color: '#1d4ed8', fontSize: 10, fontWeight: '900' }, dateHint: { color: '#64748b', fontSize: 7.5, fontWeight: '700' },
  calendarOverlay: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 18, backgroundColor: '#02061799' }, calendarCard: { width: '100%', maxWidth: 360, padding: 14, borderRadius: 18, backgroundColor: '#fff' }, calendarHead: { height: 42, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, monthButton: { width: 38, height: 34, alignItems: 'center', justifyContent: 'center', borderRadius: 9, backgroundColor: '#eff6ff' }, monthButtonText: { color: '#1d4ed8', fontSize: 24, fontWeight: '800' }, monthTitle: { color: '#0f172a', fontSize: 14, fontWeight: '900' }, weekRow: { flexDirection: 'row', marginTop: 6 }, weekDay: { width: '14.285%', color: '#64748b', fontSize: 9, fontWeight: '900', textAlign: 'center' }, days: { flexDirection: 'row', flexWrap: 'wrap', marginTop: 5 }, dayCell: { width: '14.285%', height: 38, alignItems: 'center', justifyContent: 'center', borderRadius: 9 }, dayActive: { backgroundColor: '#2563eb' }, dayText: { color: '#334155', fontSize: 11, fontWeight: '800' }, dayTextActive: { color: '#fff' }, calendarActions: { flexDirection: 'row', gap: 8, marginTop: 10 }, todayButton: { flex: 1, height: 38, alignItems: 'center', justifyContent: 'center', borderRadius: 9, backgroundColor: '#dbeafe' }, todayText: { color: '#1d4ed8', fontSize: 10, fontWeight: '900' }, closeButton: { flex: 1, height: 38, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 9 }, closeText: { color: '#475569', fontSize: 10, fontWeight: '900' },
  kpis: { flexDirection: 'row', flexWrap: 'wrap', gap: 9 }, summary: { overflow: 'hidden', borderWidth: 1, borderColor: '#dbe3ef', borderRadius: 14, backgroundColor: '#fff' }, summaryRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10, paddingHorizontal: 13, paddingVertical: 10, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#dbe3ef' }, summaryLabel: { color: '#64748b', fontSize: 12, fontWeight: '750', textTransform: 'capitalize' }, summaryMain: { color: '#1e3a5f', fontSize: 12, fontWeight: '850' }, summarySub: { marginTop: 3, color: '#64748b', fontSize: 7 }, summaryValue: { color: '#1e3a5f', fontSize: 10, fontWeight: '900' }, present: { color: '#16a34a', fontSize: 11, fontWeight: '900' }, absent: { color: '#dc2626' },
});
