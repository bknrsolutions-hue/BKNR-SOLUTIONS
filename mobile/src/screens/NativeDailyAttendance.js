...
const styles = StyleSheet.create({ notice: { marginBottom: 10, padding: 10, borderWidth: 1, borderColor: '#86efac', borderRadius: 10, color: '#166534', backgroundColor: '#f0fdf4', fontSize: 13, fontWeight: '800' }, error: { marginBottom: 10, padding: 10, borderWidth: 1, borderColor: '#fecaca', borderRadius: 10, color: '#dc2626', backgroundColor: '#fef2f2', fontSize: 13, fontWeight: '800' }, shiftFieldLabel: { marginTop: 9, marginBottom: 5, color: '#64748b', fontSize: 9.5, fontWeight: '900', letterSpacing: .4 }, shiftIcons: { gap: 7, paddingBottom: 2 }, shiftIcon: { minWidth: 96, minHeight: 76, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 8, paddingVertical: 7, borderWidth: 1, borderColor: '#dbe3ef', borderRadius: 12, backgroundColor: '#fff' }, shiftIconActive: { borderColor: '#2563eb', backgroundColor: '#eff6ff' }, shiftIconCircle: { width: 32, height: 32, alignItems: 'center', justifyContent: 'center', borderRadius: 10, backgroundColor: '#dbeafe' }, shiftIconCircleActive: { backgroundColor: '#2563eb' }, shiftIconName: { maxWidth: 90, marginTop: 4, color: '#1e3a5f', fontSize: 10, fontWeight: '900' }, shiftIconNameActive: { color: '#1d4ed8' }, shiftIconTime: { maxWidth: 90, marginTop: 2, color: '#64748b', fontSize: 8.5, fontWeight: '700' }, shiftIconTimeActive: { color: '#2563eb' }, statsRow: { gap: 7 }, stat: { minWidth: 105, minHeight: 63, justifyContent: 'center', padding: 10, borderWidth: 1, borderLeftWidth: 4, borderColor: '#dbe3ef', borderRadius: 11, backgroundColor: '#fff' }, statActive: { borderColor: '#2563eb', backgroundColor: '#eff6ff' }, statLabel: { color: '#64748b', fontSize: 11, fontWeight: '900' }, statValue: { marginTop: 4, color: '#0f172a', fontSize: 17, fontWeight: '900' }, terminal: { gap: 11, padding: 13, borderWidth: 1, borderColor: '#dbe3ef', borderRadius: 15, backgroundColor: '#fff' }, employeeInput: { height: 50, paddingHorizontal: 13, borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 12, color: '#0f172a', backgroundColor: '#fff', fontSize: 15, fontWeight: '800' }, actions: { flexDirection: 'row', gap: 7 }, action: { flex: 1, height: 43, alignItems: 'center', justifyContent: 'center', borderRadius: 10 }, actionText: { color: '#fff', fontSize: 13, fontWeight: '900' }, disabled: { opacity: .5 }, tools: { flexDirection: 'row', justifyContent: 'flex-end', gap: 7 }, auditButton: { marginTop: 10, paddingHorizontal: 13, paddingVertical: 9, borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 9, backgroundColor: '#fff' }, auditText: { color: '#2563eb', fontSize: 12, fontWeight: '900' }, row: { minHeight: 67, flexDirection: 'row', alignItems: 'center', gap: 10, padding: 11, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#dbe3ef', backgroundColor: '#fff' }, auditTargetRow: { borderWidth: 2, borderColor: '#f59e0b', backgroundColor: '#fef3c7' }, avatar: { width: 36, height: 36, alignItems: 'center', justifyContent: 'center', borderRadius: 11, backgroundColor: '#2563eb' }, avatarText: { color: '#fff', fontSize: 15, fontWeight: '900' }, rowCopy: { flex: 1, minWidth: 0 }, name: { color: '#0f172a', fontSize: 11, fontWeight: '900' }, meta: { marginTop: 3, color: '#64748b', fontSize: 11, fontWeight: '700' }, movements: { marginTop: 4, color: '#2563eb', fontSize: 10.5, fontWeight: '650' }, status: { color: '#16a34a', fontSize: 12, fontWeight: '900', textAlign: 'right' }, away: { color: '#d97706' }, hours: { marginTop: 3, color: '#2563eb', fontSize: 11, fontWeight: '800', textAlign: 'right' }, auditPage: { flex: 1, backgroundColor: '#f4f7fb' }, auditHeader: { minHeight: 64, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 15, borderBottomWidth: 1, borderBottomColor: '#dbe3ef', backgroundColor: '#fff' }, auditTitle: { color: '#0f172a', fontSize: 15, fontWeight: '900' }, auditClose: { color: '#64748b', fontSize: 27 }, auditList: { padding: 14 }, auditItem: { padding: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#dbe3ef', backgroundColor: '#fff' }, auditItemHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 }, auditMain: { color: '#2563eb', fontSize: 13, fontWeight: '900' }, auditRowId: { color: '#b45309', fontSize: 10, fontWeight: '900' }, auditSub: { marginTop: 4, color: '#64748b', fontSize: 9 }, auditValue: { marginTop: 5, color: '#1e3a5f', fontSize: 12, lineHeight: 14 }, auditLink: { marginTop: 7, color: '#2563eb', fontSize: 9.5, fontWeight: '900' } });
