...
const styles = StyleSheet.create({
  ...
  filterEyebrow: { color: '#2563eb', fontSize: 8.5, fontWeight: '900', letterSpacing: .7 },
  filterTitle: { marginTop: 1, color: '#0f172a', fontSize: 13, fontWeight: '900' },
  ...
  resetText: { color: '#2563eb', fontSize: 9.5, fontWeight: '900' },
  ...
  search: { flex: 1, height: 34, padding: 0, color: '#0f172a', fontSize: 10.5, fontWeight: '700' },
  filterStrip: { gap: 6, paddingBottom: 1 },
  filterColumn: { width: 112, flex: 0 },
  dateInput: { height: 36, paddingHorizontal: 8, borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 9, color: '#0f172a', backgroundColor: '#fff', fontSize: 10.5, fontWeight: '750' },
  filterLabel: { marginBottom: 4, color: '#64748b', fontSize: 9.5, fontWeight: '900', letterSpacing: .4, textTransform: 'uppercase' },
  ageRow: { gap: 6 },
  ...
  ageLabel: { color: '#64748b', fontSize: 9.5, fontWeight: '900' },
  ageQty: { marginTop: 3, color: '#1e3a5f', fontSize: 11, fontWeight: '900' },
  ...
  tabText: { color: '#64748b', fontSize: 9.5, fontWeight: '900', textAlign: 'center' },
  tabTextActive: { color: '#fff' },
  reportHeading: { minHeight: 48, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8, marginTop: 10 },
  reportEyebrow: { color: '#64748b', fontSize: 8.5, fontWeight: '900', letterSpacing: .65 },
  reportTitle: { marginTop: 2, color: '#0f172a', fontSize: 14, fontWeight: '900' },
  ...
  auditText: { color: '#2563eb', fontSize: 10, fontWeight: '900' },
  ...
  th: { paddingHorizontal: 3, paddingVertical: 2, borderRightWidth: StyleSheet.hairlineWidth, borderRightColor: '#31577d', color: '#ffffff', fontSize: 8.8, lineHeight: 9.3, fontWeight: '900', textAlign: 'center', textAlignVertical: 'center', textTransform: 'uppercase' },
  td: { minHeight: 19, paddingHorizontal: 3, paddingVertical: 1.5, borderRightWidth: StyleSheet.hairlineWidth, borderRightColor: '#e2e8f0', color: '#1f2f43', fontSize: 9.6, lineHeight: 10, fontWeight: '850', textAlign: 'center', textAlignVertical: 'center' },
  ...
  descriptionCell: { paddingLeft: 4, paddingRight: 2, paddingVertical: 1.5, lineHeight: 10, fontWeight: '900', textAlign: 'left', flexWrap: 'wrap' },
  ...
  totalLabel: { color: '#ffffff', fontSize: 9, fontWeight: '900' },
  totalNumber: { color: '#67e8f9', fontSize: 10.5, fontWeight: '900', textAlign: 'right' },
  noData: { padding: 22, color: '#64748b', fontSize: 11, fontWeight: '700', textAlign: 'center' },
  ...
  auditTitle: { color: '#0f172a', fontSize: 15, fontWeight: '900' },
  auditClose: { color: '#64748b', fontSize: 27 },
  ...
  auditMain: { color: '#2563eb', fontSize: 13, fontWeight: '900' },
  auditRowId: { color: '#b45309', fontSize: 10, fontWeight: '900' },
  auditSub: { marginTop: 4, color: '#64748b', fontSize: 9 },
  auditValue: { marginTop: 5, color: '#1e3a5f', fontSize: 12, lineHeight: 14 },
  auditLink: { marginTop: 7, color: '#2563eb', fontSize: 9.5, fontWeight: '900' },
});
