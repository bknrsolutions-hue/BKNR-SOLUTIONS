...
const styles = StyleSheet.create({
  ...
  headerToolLabel: { marginTop: 2, fontSize: 8.5, fontWeight: '900' },
  ...
  centerText: { maxWidth: 310, color: '#64748b', fontSize: 13, lineHeight: 19, fontWeight: '650', textAlign: 'center' },
  errorTitle: { color: '#dc2626', fontSize: 17, fontWeight: '900' },
  ...
  kpiIcon: { fontSize: 21 },
  kpiLabel: { color: '#64748b', fontSize: 11, fontWeight: '900', letterSpacing: .3, textTransform: 'uppercase' },
  kpiValue: { marginTop: 5, color: '#0f172a', fontSize: 19, fontWeight: '900' },
  kpiLink: { marginTop: 4, color: '#2563eb', fontSize: 10, fontWeight: '850' },
  sectionTitle: { marginTop: 17, marginBottom: 9, color: '#1e3a5f', fontSize: 14, fontWeight: '900', letterSpacing: .45, textTransform: 'uppercase' },
  empty: { padding: 18, color: '#64748b', fontSize: 12, fontWeight: '700', textAlign: 'center' },
});
