...
const styles = StyleSheet.create({
  ...
  label: { marginBottom: 4, color: '#64748b', fontSize: 9.5, fontWeight: '900', textTransform: 'uppercase', letterSpacing: .4 },
  ...
  value: { flex: 1, color: '#0f172a', fontSize: 11, fontWeight: '800' },
  compactValue: { fontSize: 11 },
  compactLabel: { marginBottom: 4, fontSize: 9.5 },
  placeholder: { color: '#94a3b8' },
  chevron: { color: '#2563eb', fontSize: 18, fontWeight: '900' },
  ...
  close: { color: '#64748b', fontSize: 26 },
  search: { height: 48, margin: 12, paddingHorizontal: 12, borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 11, color: '#0f172a', backgroundColor: '#f8fafc', fontSize: 13, fontWeight: '750' },
  ...
  optionText: { color: '#334155', fontSize: 13, fontWeight: '750' },
