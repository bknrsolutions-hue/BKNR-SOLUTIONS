      ...
      subgroups: [
        ...
        },
        {
          ...
          items: [
            ...
            { id: 'criteria_purchasing_locations', token: 'mst_plc', perm: 'purchasing_locations', route: '/criteria/purchasing_locations', icon: 'fa-location-dot', label: 'Purchasing Locations', badge: 'Mstr' },
