      ...
      subgroups: [
        ...
        },
        {
          ...
          items: [
            ...
            { id: 'criteria_purchasing_locations', token: 'mst_plc', perm: ['purchasing_locations', 'production_at'], route: '/criteria/purchasing_locations', icon: 'fa-location-dot', label: 'Purchasing Locations', badge: 'Mstr' },
