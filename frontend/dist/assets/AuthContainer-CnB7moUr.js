import{c as e,n as t,o as n}from"./index-BEPJdE_z.js";var r=e(n(),1),i=t();function a({handleLoginSuccess:e}){let t=(0,r.useRef)(!1),n=(0,r.useRef)(null),a=(0,r.useCallback)(e=>{let t=e.currentTarget;try{let e=t.contentDocument;if(!e?.head)return;let n=e.createElement(`style`);n.dataset.reactLoginOverrides=`true`,n.textContent=`
        .site-shell::before,
        .site-shell::after,
